...
Этап `ET-01.2` завершён: чистая математическая модель и контракт парных
RU/UK-уроков покрыты воспроизводимыми unit/contract-тестами. Следующий готовый
срез — `ET-01.3`, обновление уязвимых зависимостей.
