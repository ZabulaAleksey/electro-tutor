...
Текущий исполняемый срез описан в `AI_PLAN.md`.
...
- добавить проверку парности локалей и соответствия каталога опубликованным
  урокам;
...
- добавить contract-тесты маршрутов RU/UK.
...
## ET-04 — Проверяемый интерактив

Статус: `PLANNED`

- отделить математическую модель от React-представления;
- покрыть обычные, граничные и вырожденные значения;
- проверить восстановление query state, клавиатуру, мобильный layout и обе темы;
