...
| `PLAT-003` | application profiles отделены от identity/authority; Student и Tutor — composable private personas | `profiles-capabilities-audit.spec.md`, ADR-023, `ARCHITECTURE.md` | `ET-09.4a..e`: ordered audit→grant→profile→HTTP→E2E evidence | contracted; ET-09.4a merged, profiles planned |
...
`ET-09.2`, ET-09.3 DEV auth и `ET-09.4a` audit foundation подтверждены local
evidence; `ET-09.4a` merged into local main. Whole `ET-09.4` partial:
