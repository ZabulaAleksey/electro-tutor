...
исполнения фиксируется в выбранном record `../prompts/STAGES.md`, а порядок
...
| `features/profiles-capabilities-audit.spec.md` | Действует; runtime planned | Утверждённый `ET-09.4` contract: private Student/Tutor profiles, trusted capability grants, authorization matrix, atomic audit и ordered slices |
